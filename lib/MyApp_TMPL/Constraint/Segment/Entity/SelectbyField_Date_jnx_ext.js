...
// Selectby{{#Uc_first}}{{field_jnx}}{{/Uc_first}}Date
// 
// segment                     : {{segment}}
...
//     var selector = new Selectby({ from : "ISO8601", to : "ISO8601" });
//     
