...
// serach:
//     
//     var query = { propertyA:VALUE, propertyB:VALUE };
//     
...
var insert = function(){
	var sql = "insert into {{#Escape_reserved}}{{#Lc_first}}{{entity}}{{/Lc_first}}{{/Escape_reserved}} values ({{#Holders}}{{holder}}{{^last}},{{/last}}{{/Holders}})";
