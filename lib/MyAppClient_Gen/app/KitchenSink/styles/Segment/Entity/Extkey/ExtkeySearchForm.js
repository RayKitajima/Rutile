...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/styles/Segment/Entity/Extkey/ExtkeySearchForm.tss';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/styles/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_joined + '/' + 'SearchForm.tss';
