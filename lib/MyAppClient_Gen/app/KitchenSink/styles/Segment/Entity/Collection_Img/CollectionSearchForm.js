...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/styles/Segment/Entity/Collection_Img/CollectionSearchForm.tss';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/styles/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_collected + '/' + 'SearchForm.tss';
