...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/views/EntityList.xml';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/KitchenSink/EntityList.xml';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/views/KitchenSink');
