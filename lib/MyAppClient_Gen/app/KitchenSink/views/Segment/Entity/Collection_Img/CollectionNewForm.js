...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/views/Segment/Entity/Collection_Img/CollectionNewForm.xml';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_collected + '/' + 'NewForm.xml';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/views/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_collected);
