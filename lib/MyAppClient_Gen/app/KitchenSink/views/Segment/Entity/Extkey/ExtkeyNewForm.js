...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/views/Segment/Entity/Extkey/ExtkeyNewForm.xml';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_joined + '/' + 'NewForm.xml';
