...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/controllers/Segment/Entity/Extkey/ExtkeySearchForm.js';
...

{
	...
	Fields_joined            : containing "fieldName" and "search_types", "search_types" containing "search_type"
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/controllers/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_joined + '/SearchForm.js';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/controllers/KitchenSink/' + view.segment + '/' + view.entity + '/' + view.entity_joined);
