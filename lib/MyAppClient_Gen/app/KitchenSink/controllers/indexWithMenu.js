...
var template_file = 'MyAppClient_TMPL/app/KitchenSink/controllers/indexWithMenu.js';
...

{
	...
	GeoTools_DefaultRegion         : for Ti.Map, should be serialized
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/controllers/index.js';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/controllers/KitchenSink');
