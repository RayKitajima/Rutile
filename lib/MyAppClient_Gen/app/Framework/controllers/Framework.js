...
var template_loc = 'MyAppClient_TMPL/app/Framework/controllers';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/controllers/Framework';
	
	tools.confirmPath(output_path);
	
	var source = input_path + '/*.js';
	var dest   = output_path + '/'
	var command = 'cp ' + source + ' ' + dest;
	exec(command,function(){
		console.log("copy controllers/Framework/*.js");
	});
};
