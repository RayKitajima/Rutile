...
var template_loc = 'MyAppClient_TMPL/app/Framework/views';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/Framework';
	
	tools.confirmPath(output_path);
	
	var source = input_path + '/*.xml';
	var dest   = output_path + '/'
	var command = 'cp ' + source + ' ' + dest;
	exec(command,function(){
		console.log("copy views/Framework/*.xml");
	});
};
