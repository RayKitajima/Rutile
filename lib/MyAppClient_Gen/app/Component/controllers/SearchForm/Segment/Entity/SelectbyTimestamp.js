...
var template_file = 'MyAppClient_TMPL/app/Component/controllers/SearchForm/Segment/Entity/SelectbyTimestamp.js';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/controllers/Component/SearchForm/' + view.segment + '/' + view.entity + '/Selectby' + view.constraint_entity + tools.ucfirst(view.constraint_fieldName) + 'Timestamp.js';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/controllers/Component/SearchForm/' + view.segment + '/' + view.entity);
