...
var template_file = 'MyAppClient_TMPL/app/Component/controllers/SearchForm/Segment/Entity/SelectbyKey.js';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/controllers/Component/SearchForm/' + view.segment + '/' + view.entity + '/Selectby' + view.constraint_entity + tools.ucfirst(view.constraint_fieldName) + 'Key.js';
