...
var template_file = 'MyAppClient_TMPL/app/Component/styles/SearchForm/Segment/Entity/SelectbyDate.tss';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/styles/Component/SearchForm/' + view.segment + '/' + view.entity + '/Selectby' + view.constraint_entity + tools.ucfirst(view.constraint_fieldName) + 'Date.tss';
