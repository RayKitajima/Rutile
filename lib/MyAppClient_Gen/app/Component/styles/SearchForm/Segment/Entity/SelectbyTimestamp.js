...
var template_file = 'MyAppClient_TMPL/app/Component/styles/SearchForm/Segment/Entity/SelectbyTimestamp.tss';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/styles/Component/SearchForm/' + view.segment + '/' + view.entity + '/Selectby' + view.constraint_entity + tools.ucfirst(view.constraint_fieldName) + 'Timestamp.tss';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/styles/Component/SearchForm/' + view.segment + '/' + view.entity);
