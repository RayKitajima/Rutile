...
var template_file = 'MyAppClient_TMPL/app/Component/styles/EditForm/Segment/Entity/Extkey.tss';
...

{
	...
	segment_joined           : segment name the fieldName is biding,
	entity_joined            : entity name the fieldName is biding,
	featuredFieldName_joined : field name representing binded entity,
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/styles/Component/EditForm/' + view.segment + '/' + view.entity + '/' + tools.ucfirst(view.fieldName) + '.tss';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/styles/Component/EditForm/' + view.segment + '/' + view.entity);
