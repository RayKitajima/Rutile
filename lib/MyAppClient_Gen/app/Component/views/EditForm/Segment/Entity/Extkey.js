...
var template_file = 'MyAppClient_TMPL/app/Component/views/EditForm/Segment/Entity/Extkey.xml';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/Component/EditForm/' + view.segment + '/' + view.entity + '/' + tools.ucfirst(view.fieldName) + '.xml';
	
	tools.confirmPath(output_dir + '/' + CLIENT_NAME + '/app/views/Component/EditForm/' + view.segment + '/' + view.entity);
