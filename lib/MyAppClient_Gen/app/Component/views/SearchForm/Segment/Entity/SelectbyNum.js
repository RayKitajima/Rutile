...
var template_file = 'MyAppClient_TMPL/app/Component/views/SearchForm/Segment/Entity/SelectbyNum.xml';
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + CLIENT_NAME + '/app/views/Component/SearchForm/' + view.segment + '/' + view.entity + '/Selectby' + view.constraint_entity + tools.ucfirst(view.constraint_fieldName) + 'Num.xml';
