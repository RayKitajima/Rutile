...
var template_file = 'MyApp_TMPL/Constraint/Segment/Entity/Limit.js';
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + '/Constraint/' + view.segment + '/' + view.entity + '/Limit.js';
