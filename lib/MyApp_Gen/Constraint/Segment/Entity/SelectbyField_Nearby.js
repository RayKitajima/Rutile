...
var template_file = 'MyApp_TMPL/Constraint/Segment/Entity/SelectbyField_Nearby.js';
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + '/Constraint/' + view.segment + '/' + view.entity + '/Selectby' + view.entity + Uc_first(view.field) + 'Nearby.js';
