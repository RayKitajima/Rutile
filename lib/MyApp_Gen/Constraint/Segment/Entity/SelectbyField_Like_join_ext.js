...
var template_file = 'MyApp_TMPL/Constraint/Segment/Entity/SelectbyField_Like_join_ext.js';
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + '/Constraint/' + view.segment + '/' + view.entity + '/Selectby' + view.entity_joined + Uc_first(view.field_joined) + 'Like.js';
