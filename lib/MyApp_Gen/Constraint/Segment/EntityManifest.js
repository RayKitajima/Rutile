...
var template_file = 'MyApp_TMPL/Constraint/Segment/EntityManifest.js';
...

{
	...
	Selectbys : [
		{
			search_segment : segment of search constarint field beloging in,
			search_entity  : entity of search constarint field belongging in,
			search_field   : search constarint field name,
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + '/Constraint/' + view.segment + '/' + view.entity + 'Manifest.js';
