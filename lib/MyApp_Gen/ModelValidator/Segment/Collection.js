...
var template_file = 'MyApp_TMPL/ModelValidator/Segment/Collection.js';
...

{
	...
	collectorSegment : segment of collector (not needed)
	collectorEntity  : collector entity (not needed)
	collectorID      : primary key of collector entity (not needed)
	
	collectedSegment : segment of collected item
	collectedEntity  : collected entity
	collectedID      : primary key of collected entity
