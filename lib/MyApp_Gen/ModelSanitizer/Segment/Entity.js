...
var template_file = 'MyApp_TMPL/ModelSanitizer/Segment/Entity.js';
...

{
	...
	Fields : [ 
		{ 
			field               : FIELD, 
			typedSanitizeMethod : sanitizer based on field type 
			sanitizes           : user defined sanitization
			last                : 0|1,
		} 
	],
...
var generate = function(options){
	...
	var output_path = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + '/ModelSanitizer/' + view.segment + '/' + view.entity + '.js';
