...
exports.removeView = function(view){
	viewContainer.remove(view);
};

exports.makeVisible = function(){
	$.NavigationGroup.visible = true;
	viewContainer.visible = true;
};

exports.makeUnvisible = function(){
...
var applySideMenuButton = function(){
	var sideMenuButton = Alloy.createController('Framework/NaviMenuButton');
	sideMenuButton.setButtonHandler(showSideMenu);
	addLeftButton(sideMenuButton.getView());
};

exports.setSideMenu = function(new_sideMenu){
	sideMenu = new_sideMenu;
};

exports.enableSideMenu = function(){
...
exports.setFirstPage = function(controller){
	firstpage_controller = controller;
};

exports.openFirstPage = function(){
	self.init();
	self.open(firstpage_controller);
};

exports.open = function(controller){
	if( !Alloy.Globals.navigationControllerStack ){ // called in single navi mode
