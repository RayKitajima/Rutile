...
var fieldManifest = [
	'{{primary_key}}',
{{#Fields}}
	'{{fieldName}}'{{^lastOfJoiningCollectedFields}},{{/lastOfJoiningCollectedFields}}
{{/Fields}}
{{#Fields_collected}}
	'{{primary_key_collected}}s'{{^lastOfJoiningCollectedFields}},{{/lastOfJoiningCollectedFields}} // pseudo field for collection
{{/Fields_collected}}
];
