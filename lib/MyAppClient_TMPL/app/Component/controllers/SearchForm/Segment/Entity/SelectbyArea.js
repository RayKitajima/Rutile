...
var addItem = function(){
	var item = Alloy.createController('Framework/SearchFormElementArea');
...
// for internal program, adding Framework/SearchFormElementArea instance without ui
exports.addItem = function(item){
	items.push(item);
};

// for internal program, removing Framework/SearchFormElementArea instance without ui
