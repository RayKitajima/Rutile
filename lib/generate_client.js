...
var AppHost   = MyAppConfig.Server   || '127.0.0.1';
var AppPort   = MyAppConfig.Port     || 3000;
var DBHost    = MyAppConfig.DBHost   || '127.0.0.1';
var DBPort    = MyAppConfig.Port     || 5432;
var CacheHost = MyAppConfig.DBHost   || '127.0.0.1';
var CachePort = MyAppConfig.Port     || 6379;
...
console.log("generating dynamic lib files");
Generator.generate("lib/CentralDispatch", "common", config);
