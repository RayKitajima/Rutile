...
var template_file = 'MyAppImpl_TMPL/Logic/AuthPassword.js';
var output_file   = 'Logic/AuthPassword.js';
...

{
	...
	auth_segment    : segment defining id and pass
	auth_entity     : entity defining id and pass
	auth_id_field   : id field name
	auth_pass_field : password field name
}
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + 'Impl' + '/' + output_file;
