...
var template_file = 'MyAppConfig_TMPL/MyAPPConfig.js';
...
var generate = function(options){
	...
	var output_path   = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + 'Config/' + APP_NAME + 'Config.js';
	
	// prepare directoreis
	var dir = output_dir + '/' + SERVER_NAME + '/' + APP_NAME + 'Config';
