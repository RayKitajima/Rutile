...
// Model/ModelImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating ModelImplFactory");
Generator.generate("Model/ModelImplFactory",config);

// ModelSanitizer/ModelSanitizerImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating ModelSanitizerImplFactory");
Generator.generate("ModelSanitizer/ModelSanitizerImplFactory",config);

// ModelValidator/ModelValidatorImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating ModelValidatorImplFactory");
Generator.generate("ModelValidator/ModelValidatorImplFactory",config);

// Constraint/ConstraintImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating ConstraintImplFactory");
Generator.generate("Constraint/ConstraintImplFactory",config);

// Constraint/SelectbyImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating SelectbyImplFactory");
Generator.generate("Constraint/SelectbyImplFactory",config);

// Constraint/OrderbyImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating OrderbyImplFactory");
Generator.generate("Constraint/OrderbyImplFactory",config);

// Logic/LogicImplFactory
config.view = {
	APP_NAME : APP_NAME
};
console.log("generating LogicImplFactory");
Generator.generate("Logic/LogicImplFactory",config);
